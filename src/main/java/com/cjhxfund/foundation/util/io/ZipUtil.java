...
public class ZipUtil {
	...
	private static JLogger logger = SysLogger.getLogger(ZipUtil.class);
	...
	public static void zip(String srcPath, String zipPath, String zipFileName) 
	{
		...
		try
		{
			...
			{
				logger.error("zipPath must not be the child directory of srcPath.");
				return;
			}
